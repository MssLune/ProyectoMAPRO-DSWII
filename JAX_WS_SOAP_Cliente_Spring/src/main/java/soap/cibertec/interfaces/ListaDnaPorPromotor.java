...
/**
 * <p>Clase Java para listaDnaPorPromotor complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listaDnaPorPromotor">
 *   &lt;complexContent>
...
@XmlType(name = "listaDnaPorPromotor", propOrder = {
    "codigoPromotor"
})
public class ListaDnaPorPromotor {
