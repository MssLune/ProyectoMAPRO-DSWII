...
/**
 * <p>Clase Java para listaDnaPorDepartamento complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="listaDnaPorDepartamento">
 *   &lt;complexContent>
...
@XmlType(name = "listaDnaPorDepartamento", propOrder = {
    "idDepartamento"
})
public class ListaDnaPorDepartamento {
