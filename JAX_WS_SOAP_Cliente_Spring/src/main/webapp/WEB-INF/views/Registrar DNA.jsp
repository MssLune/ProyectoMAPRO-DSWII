                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="registraDNA" method="post" class="needs-validation" novalidate>
                                            ...
                                            <div class="form-group position-relative mb-3">
                                             ...
                                             <div class="form-group position-relative mb-3">
                                                <label for="validationTooltip01" for="direccionDna">Dirección</label>
					 					  ...
					 					  <div class="col-md-6"  style="margin-left: -15px;">
                                            ...
                                            <div class="form-group position-relative mb-3">
                                                <label for="validationTooltip03" for="telefonoDna">Teléfono</label>
                                                <input type="text" class="form-control" id="id_telefono" name="telefono" placeholder="Teléfono" required>
                                               
                                                <div class="invalid-tooltip">
                                                    Por favor ingrese una Teléfono.
                                                </div>
                                            </div>
                                            
                                              <div class="form-group position-relative mb-3">
                                                <label for="validationTooltip03" for="diaDna">Días</label>
                                                <input type="text" class="form-control" id="id_dias" name="dia" placeholder="Días" required>
