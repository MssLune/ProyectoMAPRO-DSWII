CREATE DATABASE  IF NOT EXISTS `proyecto_lp` /*!40100 DEFAULT CHARACTER SET utf8 */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `proyecto_lp`;
-- MySQL dump 10.13  Distrib 8.0.18, for Win64 (x86_64)
--
-- Host: localhost    Database: proyecto_lp
-- ------------------------------------------------------
...
CREATE TABLE `boleta` (
  ...
  CONSTRAINT `fk_idcliente` FOREIGN KEY (`idcliente`) REFERENCES `promotor` (`codigoPromotor`),
  CONSTRAINT `fk_idusuario` FOREIGN KEY (`idusuario`) REFERENCES `usuario` (`codigoUsuario`)
...
INSERT INTO `boleta` VALUES (1,1,35,'2018-12-03'),(4,1,34,'2019-12-02'),(6,1,34,'2019-12-02'),(7,1,34,'2019-12-02'),(8,1,35,'2019-12-02'),(9,1,34,'2019-12-02'),(10,1,34,'2019-12-02'),(11,1,35,'2019-12-02'),(12,1,34,'2019-12-02'),(15,1,34,'2019-12-02');
...
INSERT INTO `cargo` VALUES (1,'Administrador'),(2,'Técnco'),(3,'Especialista Social'),(4,'Secretaria'),(5,'Director');
...
CREATE TABLE `departamento` (
  ...
  `nombreDepartamento` varchar(50) DEFAULT NULL COMMENT 'nombre del departamento',
...
CREATE TABLE `detalle_boleta` (
  ...
  PRIMARY KEY (`idboleta`),
  KEY `fk_iddna_idx` (`iddna`),
  CONSTRAINT `fk_idboleta` FOREIGN KEY (`idboleta`) REFERENCES `boleta` (`idboleta`),
  CONSTRAINT `fk_iddna` FOREIGN KEY (`iddna`) REFERENCES `dna` (`codigoDna`)
...
INSERT INTO `detalle_boleta` VALUES (1,7,70),(6,6,70),(7,6,70),(8,7,70),(9,6,70),(10,6,70),(11,7,70),(12,6,70),(15,6,70);
...
CREATE TABLE `distrito` (
  ...
  `nombreDistrito` varchar(50) DEFAULT NULL COMMENT 'nombre de distrito',
...
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `dna` (
  `codigoDna` int(11) NOT NULL AUTO_INCREMENT,
  `nombreDNA` varchar(45) DEFAULT NULL,
  `documentoDna` varchar(45) DEFAULT NULL,
  `direccionDna` varchar(45) DEFAULT NULL,
  `idDepartamento` int(11) NOT NULL,
  `idProvincia` int(11) NOT NULL,
  `idDistrito` int(11) NOT NULL,
  `telefonoDna` int(9) DEFAULT NULL,
  `diasDNA` int(11) DEFAULT NULL,
  `ambienteDNA` int(11) DEFAULT NULL,
  `ambienteprivDNA` int(11) DEFAULT NULL,
  `codigoPromotor` int(11) DEFAULT NULL,
  PRIMARY KEY (`codigoDna`),
  KEY `fk_Dna_Distrito1_idx` (`idDistrito`),
  KEY `fk_Dna_Provincia1_idx` (`idProvincia`),
  KEY `fk_Dna_Departamentos1_idx` (`idDepartamento`),
  KEY `fk_Dna_Promotor_idx` (`codigoPromotor`),
  CONSTRAINT `fk_Dna_Departamentos` FOREIGN KEY (`idDepartamento`) REFERENCES `departamento` (`idDepartamento`),
  CONSTRAINT `fk_Dna_Distrito` FOREIGN KEY (`idDistrito`) REFERENCES `distrito` (`idDistrito`),
  CONSTRAINT `fk_Dna_Promotor` FOREIGN KEY (`codigoPromotor`) REFERENCES `promotor` (`codigoPromotor`),
  CONSTRAINT `fk_Dna_Provincia` FOREIGN KEY (`idProvincia`) REFERENCES `provincia` (`idProvincia`)
...
INSERT INTO `dna` VALUES (6,'Gabriela','Ficha Única','mz o lt 2',15,134,1372,936801341,15,20,9,34),(7,'Gabriela Ana','Ficha Única','Mz D Lt 16 Av. San Antonio',18,148,1499,970601943,20,20,20,35);
...
CREATE TABLE `expediente` (
  ...
  `promotor_codigoPromotor1` int(11) NOT NULL,
  `dna_codigoDna` int(11) NOT NULL,
  PRIMARY KEY (`idExpediente`),
  KEY `fk_expediente_promotor2_idx` (`promotor_codigoPromotor1`),
  KEY `fk_expediente_dna1_idx` (`dna_codigoDna`),
  CONSTRAINT `fk_expediente_dna1` FOREIGN KEY (`dna_codigoDna`) REFERENCES `dna` (`codigoDna`),
  CONSTRAINT `fk_expediente_promotor2` FOREIGN KEY (`promotor_codigoPromotor1`) REFERENCES `promotor` (`codigoPromotor`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `grado` VALUES (1,'Primaria'),(2,'Secundaria'),(3,'Técnico'),(4,'Universitario');
...
CREATE TABLE `promotor` (
  `codigoPromotor` int(11) NOT NULL AUTO_INCREMENT,
  `nombrePromotor` varchar(45) DEFAULT NULL,
  `apellidoPromotor` varchar(45) DEFAULT NULL,
  `idDepartamento` int(11) NOT NULL,
  `idProvincia` int(11) NOT NULL,
  `idDistrito` int(11) NOT NULL,
  `direccionPromotor` varchar(60) DEFAULT NULL,
  `dniPromotor` int(8) DEFAULT NULL,
  `idGenero` int(11) NOT NULL,
  `telefonoPromotor` int(9) DEFAULT NULL,
  `emailPromotor` varchar(45) DEFAULT NULL,
  `idGrado` int(11) NOT NULL,
  PRIMARY KEY (`codigoPromotor`),
  KEY `fk_promotor_genero2_idx` (`idGenero`),
  KEY `fk_promotor_grado2_idx` (`idGrado`),
  KEY `fk_Promotor_Distrito1_idx` (`idDistrito`),
  KEY `fk_Promotor_Provincia1_idx` (`idProvincia`),
  KEY `fk_Promotor_Departamentos1_idx` (`idDepartamento`),
  CONSTRAINT `fk_Promotor_Departamentos` FOREIGN KEY (`idDepartamento`) REFERENCES `departamento` (`idDepartamento`),
  CONSTRAINT `fk_Promotor_Distrito` FOREIGN KEY (`idDistrito`) REFERENCES `distrito` (`idDistrito`),
  CONSTRAINT `fk_Promotor_Provincia` FOREIGN KEY (`idProvincia`) REFERENCES `provincia` (`idProvincia`),
  CONSTRAINT `fk_promotor_genero` FOREIGN KEY (`idGenero`) REFERENCES `genero` (`idGenero`),
  CONSTRAINT `fk_promotor_grado` FOREIGN KEY (`idGrado`) REFERENCES `grado` (`idGrado`)
...
INSERT INTO `promotor` VALUES (34,'Fabiola','Sanchez Quispe',4,3,3,'mz o lt 2',44348209,1,985647833,'fabiola.sanchez@gmail.come',1),(35,'Franco Antonio','Huaman Guevara',5,3,4,'Mz D Lt 16 Av. San Antonio',8456123,1,951456253,'arnold.v@gmail.com',2);
...
CREATE TABLE `provincia` (
  ...
  `nombreProvincia` varchar(50) DEFAULT NULL COMMENT 'nombre de provincia',
...
CREATE TABLE `usuario` (
  ...
  KEY `usuario_cargo_idx` (`idCargo`),
  CONSTRAINT `usuario_cargo` FOREIGN KEY (`idCargo`) REFERENCES `cargo` (`idCargo`)
...
INSERT INTO `usuario` VALUES (1,'Xamir','Diaz Caballero','xdiazc','xdiazc','xdiaz@gmail.com','1992-02-12',1),(2,'Ronal','Huaccha Rivera','rhuacchar','rhuacchar','ronal_huaccha@gmail.com','1992-05-11',2),(3,'Franck','Huaman','fhuaman','fhuaman','franco@gmail.com','1992-10-11',3),(4,'Geraldine ','Jayo Escalante','gjayo','gjayo','geraldine.jayo@gmail.com','1999-10-11',4);
/*!40000 ALTER TABLE `usuario` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'proyecto_lp'
--

--
-- Dumping routines for database 'proyecto_lp'
--
/*!50003 DROP PROCEDURE IF EXISTS `actualizar_cargo` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_cargo`(
in vnomcar varchar(45),
in idcar int
)
BEGIN
update cargo set nombreCargo = vnomcar where idCargo = idcar;
END ;;
DELIMITER ;
...
/*!50003 DROP PROCEDURE IF EXISTS `actualizar_dna` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_dna`(
in vnomdna varchar(45),
in vdocdna varchar(45),
in vdirdna varchar(45),
in vdepdna int,
in vprodna int,
in vdisdna int,
in vteldna int(9),
...
BEGIN
update dna set nombreDNA=vnomdna,documentoDna=vdocdna,direccionDna=vdirdna,
		idDepartamento=vdepdna,idProvincia=vprodna,idDistrito=vdisdna,
        telefonoDna=vteldna,diasDNA=vdiadna,ambienteDNA=vambdna,ambienteprivDNA=vampdna,codigoPromotor=vpromodna
        where codigoDna=codigo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `actualizar_promotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `actualizar_promotor`(
in vnompro varchar(45),
in vapepro varchar(45),
in vdeppro int,
in vpropro int,
in vdispro int,
in vdirpro varchar(45),
in vdnipro int(8),
in vgenpro int,
in vtelpro int(9),
in vemapro varchar(45),
in vgrapro int,
in codpro int
)
BEGIN
update promotor set nombrePromotor=vnompro,apellidoPromotor=vapepro,idDepartamento=vdeppro,idProvincia=vpropro,idDistrito=vdispro,
					direccionPromotor=vdirpro,dniPromotor=vdnipro,idGenero=vgenpro,telefonoPromotor=vtelpro,emailPromotor=vemapro,
                    idGrado=vgrapro 
					where codigoPromotor=codpro;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
in vnomusu varchar(45),
in vapeusu varchar(45),
in vidusu varchar(45),
in vpasusu varchar(45),
in vcorusu varchar(45),
in vfecusu varchar(45),
in vcarusu int, in codUsu int
)
BEGIN
update usuario set nombreUsuario=vnomusu,apellidoUsuario=vapeusu,idUsuario=vidusu,passwordUsuario=vpasusu,correoUsuario=vcorusu,fechaUsuario=vfecusu,idCargo=vcarusu
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `buscarDNA` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `buscarDNA`()
BEGIN
select p.*,d.nombreDepartamento,pro.nombreProvincia,dis.nombreDistrito ,prom.nombrePromotor  
from dna p join departamento d 
on p.idDepartamento = d.idDepartamento join provincia pro on p.idProvincia=pro.idProvincia join distrito dis 
on p.idDistrito=dis.idDistrito join promotor prom on p.codigoPromotor=prom.codigoPromotor;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `buscar_promotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `buscar_promotor`()
BEGIN
select p.*,d.nombreDepartamento,pro.nombreProvincia,dis.nombreDistrito,ge.nombreGenero,g.nombreGrado from promotor p join departamento d 
on p.idDepartamento = d.idDepartamento join provincia pro on p.idProvincia=pro.idProvincia join distrito dis 
on p.idDistrito=dis.idDistrito join genero ge on p.idGenero=ge.idGenero join grado g on p.idGrado=g.idGrado;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminar_cargo`(
in idcar int
)
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `eliminar_dna` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminar_dna`(
in coddna int
)
BEGIN
delete from dna where codigoDna=coddna;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `eliminar_promotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `eliminar_promotor`(
in codpro int
)
BEGIN
delete from promotor where codigoPromotor=codpro;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
delete from usuario where codigoUsuario=codusu;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listaExpCadena` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listaExpCadena`(cadena varchar(20))
BEGIN
select e.idExpediente,
		e.estado,
        p.nombrePromotor,
        d.nombreDNA
 from expediente e inner join promotor p 
on e.promotor_codigoPromotor1=p.codigoPromotor
inner join dna d on e.dna_codigoDna=d.codigoDna
where e.estado=cadena;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listaExpediente` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listaExpediente`()
BEGIN
select e.idExpediente,
		e.estado,
        p.nombrePromotor,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listaExpeXPromotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listaExpeXPromotor`(dato int)
BEGIN
select e.idExpediente,
		e.estado,
        p.nombrePromotor,
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listarDnaCodigo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarDnaCodigo`(in cod int)
BEGIN
select * from dna d
where d.codigoDna like cod;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listarDNAxCaracteres` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarDNAxCaracteres`(in cod int)
BEGIN
select * from dna d
where d.codigoDna like cod;
END ;;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listarDNAxPromotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarDNAxPromotor`(in codigo int)
BEGIN
select d.codigoDna,d.nombreDNA,d.documentoDna,d.direccionDna,dep.nombreDepartamento,p.nombreProvincia,dis.nombreDistrito,
		d.telefonoDna,d.diasDNA,d.ambienteDNA,d.ambienteprivDNA, prop.nombrePromotor
from dna d inner join departamento dep
on d.idDepartamento = dep.idDepartamento inner join provincia p
on d.idProvincia = p.idProvincia inner join distrito dis
on d.idDistrito = dis.idDistrito inner join promotor prop
on d.codigoPromotor = prop.codigoPromotor
where prop.codigoPromotor = codigo;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listarPromotorXCaracteres` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarPromotorXCaracteres`(in vnompro varchar(45))
BEGIN
select p.codigoPromotor,p.nombrePromotor,apellidoPromotor,d.nombreDepartamento,pro.nombreProvincia,dis.nombreDistrito,
p.direccionPromotor,p.dniPromotor,ge.nombreGenero,p.telefonoPromotor,p.emailPromotor,gra.nombreGrado
from proyecto_lp.promotor as p inner join proyecto_lp.departamento as d
on p.idDepartamento = d.idDepartamento inner join proyecto_lp.provincia as pro
on p.idProvincia = pro.idProvincia inner join proyecto_lp.distrito as dis 
on p.idDistrito = dis.idDistrito inner join proyecto_lp.genero as ge
on p.idGenero = ge.idGenero inner join proyecto_lp.grado as gra
on p.idGrado = gra.idGrado
where p.nombrePromotor like vnompro;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listarUsuarioxCaracteres` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listarUsuarioxCaracteres`(in vnomusu varchar(45))
BEGIN
select u.codigoUsuario,u.nombreUsuario,u.apellidoUsuario,u.idUsuario,u.passwordUsuario,u.correoUsuario,
u.fechaUsuario,c.nombreCargo from usuario u inner join cargo c
on u.idCargo=c.idCargo
where u.nombreUsuario like vnomusu;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_boleta` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_boleta`()
BEGIN
select * from boleta;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_cargo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_cargo`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_departamento` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_departamento`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_distrito` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_distrito`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_dna` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_dna`()
BEGIN
select * from dna;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_genero` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_genero`()
BEGIN
select * from genero;
END ;;
DELIMITER ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_grado`()
BEGIN
select * from grado;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_promotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_promotor`()
BEGIN
select p.codigoPromotor,p.nombrePromotor,apellidoPromotor,d.nombreDepartamento,pro.nombreProvincia,dis.nombreDistrito,
p.direccionPromotor,p.dniPromotor,ge.nombreGenero,p.telefonoPromotor,p.emailPromotor,gra.nombreGrado
from proyecto_lp.promotor as p inner join proyecto_lp.departamento as d
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_promotor_origin` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_promotor_origin`()
BEGIN
select p.*,d.nombreDepartamento,pro.nombreProvincia,dis.nombreDistrito, 
ge.nombreGenero,gra.nombreGrado
from proyecto_lp.promotor as p inner join proyecto_lp.departamento as d
on p.idDepartamento = d.idDepartamento inner join proyecto_lp.provincia as pro
on p.idProvincia = pro.idProvincia inner join proyecto_lp.distrito as dis 
on p.idDistrito = dis.idDistrito inner join proyecto_lp.genero as ge
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_provincia` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'NO_AUTO_VALUE_ON_ZERO' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_provincia`()
BEGIN
...
BEGIN
select u.codigoUsuario,u.nombreUsuario,u.apellidoUsuario,u.idUsuario,u.passwordUsuario,u.correoUsuario,u.fechaUsuario,u.idCargo from usuario u ;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listar_usuario_x_Cargo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listar_usuario_x_Cargo`(in idCar int)
BEGIN
select u.codigoUsuario,u.nombreUsuario,u.apellidoUsuario,u.idUsuario,u.passwordUsuario,u.correoUsuario,
u.fechaUsuario,c.nombreCargo from usuario u inner join cargo c
on u.idCargo=c.idCargo
where u.idCargo=idCar;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `listaXCargoCaracter` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listaXCargoCaracter`( nc varchar(20))
BEGIN
SELECT * FROM cargo a where a.nombreCargo=nc;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `lista_DNA_x_Departamento` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `lista_DNA_x_Departamento`(in idDepa int)
BEGIN
select d.codigoDna,d.nombreDNA,d.documentoDna,d.direccionDna,dep.nombreDepartamento,p.nombreProvincia,dis.nombreDistrito,
		d.telefonoDna,d.diasDNA,d.ambienteDNA,d.ambienteprivDNA, prop.nombrePromotor
from dna d inner join departamento dep
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `lista_promotor_x_Departamento` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `lista_promotor_x_Departamento`(in idDepa int)
BEGIN
select p.codigoPromotor,p.nombrePromotor,apellidoPromotor,d.nombreDepartamento,pro.nombreProvincia,dis.nombreDistrito,
p.direccionPromotor,p.dniPromotor,ge.nombreGenero,p.telefonoPromotor,p.emailPromotor,gra.nombreGrado
from proyecto_lp.promotor as p inner join proyecto_lp.departamento as d
...
BEGIN
select * from usuario where idUsuario=id and passwordUsuario=pas; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `loginCargo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `loginCargo`(in id varchar(45))
BEGIN
select * from usuario
where idCargo=1 and idUsuario=id;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
BEGIN
select idUsuario, passwordUsuario,idCargo from usuario where idUsuario=id and passwordUsuario=pas; 
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `registrar_cargo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrar_cargo`(
in nombreCargo varchar(45)
)
BEGIN

insert into cargo values (null,nombreCargo);
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `registrar_dna` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrar_dna`(
in nombreDna varchar(45),
in documentoDna varchar(45),
in direccionDna varchar(45),
in idDepartamento int,
in idProvincia int,
in idDistrito int,
in telefonoDna int(9),
in diasDNA int,
in ambienteDNA int,
in ambienteprivDNA int,
in codigoPromotor int
)
BEGIN
insert into dna values (null,nombreDna,documentoDna,direccionDna,idDepartamento,idProvincia,idDistrito,telefonoDna,diasDNA,ambienteDNA,ambienteprivDNA,codigoPromotor);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `registrar_promotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `registrar_promotor`(
in nombrePromotor varchar(45),
in apellidoPromotor varchar(45),
in idDepartamento int,
in idProvincia int,
in idDistrito int,
in direccionPromotor varchar(45),
in dniPromotor int(8),
in idGenero int,
in telefonoPromotor int(9),
in emailPromotor varchar(45),
in idGrado int
)
BEGIN
insert into promotor values (null,nombrePromotor,apellidoPromotor,idDepartamento,idProvincia,idDistrito,direccionPromotor,dniPromotor,idGenero,telefonoPromotor,emailPromotor,idGrado);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
in passwordUsuario varchar(45),
in correoUsuario varchar(45),
in fechaUsuario varchar(45),
in idCargo int
)
BEGIN
insert into usuario values(null,nombreUsuario,apellidoUsuario,idUsuario,passwordUsuario,correoUsuario,fechaUsuario,idCargo);
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `reporteCargo` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `reporteCargo`()
BEGIN
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `reporteDNA` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `reporteDNA`(nombre varchar(20))
BEGIN
select d.codigoDna, 
	   d.nombreDNA,
       d.documentoDna,
       ...
       d.ambienteprivDNA,
       pro.nombrePromotor
from dna as d inner join departamento as de
on d.idDepartamento=de.idDepartamento inner join provincia as p
on d.idProvincia=p.idProvincia inner join distrito as dis
on d.idDistrito=dis.idDistrito inner join promotor as pro
on d.codigoPromotor=pro.codigoPromotor where pro.nombrePromotor=nombre;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `reportePromotor` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `reportePromotor`(depa varchar(20))
BEGIN
select p.codigoPromotor,
	   p.nombrePromotor,
       p.apellidoPromotor,
       ...
       p.emailPromotor,
       gra.nombreGrado
 from promotor as p inner join departamento as depa
on p.idDepartamento=depa.idDepartamento inner join provincia as pro
on p.idProvincia=pro.idProvincia inner join distrito as d
on p.idDistrito=d.idDistrito inner join genero as g
on p.idGenero=g.idGenero inner join grado as gra
on p.idGrado=gra.idGrado where depa.nombreDepartamento = depa;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `reporteUsuario` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `reporteUsuario`(ini date,fin date)
BEGIN
select u.codigoUsuario,
       ...
       u.fechaUsuario,
       u.idCargo
 from usuario as u where u.fechaUsuario between ini and fin;
END ;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
-- Dump completed on 2019-12-02 18:49:31
